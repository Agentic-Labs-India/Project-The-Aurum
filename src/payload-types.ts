...
export interface Config {
  ...
  blocks: {
    ...
    aurumTemplate: AurumTemplateBlock;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumTemplateBlock".
 */
export interface AurumTemplateBlock {
  aurumTemplateFields?: {
    settings?: {
      /**
       * Leave blank for system default
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumHeroSection".
 */
export interface AurumHeroSection {
  /**
   * Logo image only — brand name text is not shown in the nav.
   */
  logo?: (string | null) | Media;
  /**
   * Used for aria-label / sheet title only. Not displayed next to the logo.
   */
  brandName?: string | null;
  /**
   * Links shown in the sheet menu opened from the hamburger.
   */
  navLinks?:
    | {
        link: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumAboutSection".
 */
export interface AurumAboutSection {
  eyebrow?: string | null;
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumRoomsSection".
 */
export interface AurumRoomsSection {
  eyebrow?: string | null;
  headline: string;
  description: string;
  cta: {
  ...
  /**
   * Displayed as a 3-up top row, then a 2-up bottom row when 5 rooms are set.
   */
  rooms?:
    | {
        image?: (string | null) | Media;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumAmenitiesSection".
 */
export interface AurumAmenitiesSection {
  eyebrow?: string | null;
  headline: string;
  description: string;
  items?:
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumInteriorSection".
 */
export interface AurumInteriorSection {
  eyebrow?: string | null;
  headline: string;
  description: string;
  features?:
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumDetailsSection".
 */
export interface AurumDetailsSection {
  image?: (string | null) | Media;
  caption?: string | null;
  cta: {
    type?: ('reference' | 'custom') | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumTestimonialsSection".
 */
export interface AurumTestimonialsSection {
  testimonials?:
    | {
        image?: (string | null) | Media;
        quote: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AurumGallerySection".
 */
export interface AurumGallerySection {
  /**
   * Displayed as a seamless full-width strip with no gaps between images.
   */
  images?:
    | {
        image: string | Media;
...
export interface Footer {
  ...
  /**
   * Logo only — brand name text is not shown.
   */
  logo?: (string | null) | Media;
  tagline?: string | null;
  socialLinks?:
